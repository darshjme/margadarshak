...
<img src="assets/agent-router-hero.png" alt="agent-router — Vedic Arsenal by Darshankumar Joshi" width="100%" />

# 🪷 agent-router

<h3><em>मार्गदर्शक</em></h3>

> *Margadarshak — the divine guide, cosmic router*
...
```mermaid
flowchart LR
    A[Input] --> B[agent-router]
    B --> C{Process}
    C -- Success --> D[Output]
    C -- Error --> E[Handle / Retry]
    E --> B
    style B fill:#6b21a8,color:#fff
    note["Router — Zero Dependencies"]
```
